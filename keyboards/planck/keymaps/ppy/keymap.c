...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_planck_grid(
            ...
            KC_TILD, KC_LPRN, KC_RPRN, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_MINS, KC_ASTR, KC_LCBR, KC_RCBR, KC_BSLS,
            _______, KC_EXLM, KC_AT,   KC_PLUS, KC_EQL,  KC_LT,   KC_GT,   KC_AMPR, KC_PIPE, KC_LBRC, KC_RBRC, KC_UNDS,
    ...
    [_GAME] = LAYOUT_planck_grid(
            ...
            KC_ESC,  _______, _______, FKEYS,   KC_SPC,  _______, _______, _______, _______, _______, XBX_IMG, XBX_MOV),
