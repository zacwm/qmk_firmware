...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_planck_grid(
            ...
            MEH,     KC_LCTL, KC_LALT, FKEYS,   KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  VIM_START,KVM_SWT,COPY,    PASTE),

    [_LOWER] = LAYOUT_planck_grid(
            KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, 
            KC_TILD, KC_LPRN, KC_RPRN, KC_PLUS, KC_EQL,  KC_LT,   KC_GT,   KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, KC_MINS,
            _______, KC_EXLM, KC_AT,   KC_HASH, S(KC_V), KC_LT,   KC_GT,   KC_UNDS, KC_LT,   KC_GT,   KC_BSLS, KC_UNDS,
