...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_planck_grid(
            ...
            KC_TILD, KC_LPRN, KC_RPRN, KC_HASH, KC_EQL,  KC_LT,   KC_GT,   KC_MINS, KC_ASTR, KC_LCBR, KC_RCBR, KC_PIPE,
            _______, KC_EXLM, KC_AT,   KC_PLUS, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_LBRC, KC_RBRC, KC_BSLS, KC_UNDS,
